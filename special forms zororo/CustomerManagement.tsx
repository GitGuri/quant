...
export function CustomerManagement() {
    ...
    const fetchCustomers = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(`https://quantnow-sa1e.onrender.coms/cluster-data`, {
                headers: {
    ...
    const fetchApplications = useCallback(async () => {
        ...
        try {
            const headers = getAuthHeaders();
            const response = await fetch(`https://quantnow-sa1e.onrender.comions`, { headers });
    ...
    const handleCreateCustomer = async (payload: CustomerSaveData): Promise<boolean> => {
        try {
            const response = await fetch('https://quantnow-sa1e.onrender.com's', {
                method: 'POST',
    ...
    const handleUpdateCustomer = async (id: string, payload: CustomerSaveData): Promise<boolean> => {
        try {
            const response = await fetch(`https://quantnow-sa1e.onrender.coms/${id}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json', ...getAuthHeaders() },
                body: JSON.stringify(payload)
            });
    ...
    const handleCreateApplication = async (payload: ApplicationSaveData): Promise<boolean> => {
        try {
            const response = await fetch('https://quantnow-sa1e.onrender.com'ions', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', ...getAuthHeaders() },
                body: JSON.stringify(payload)
            });
    ...
    const handleUpdateApplication = async (id: string, payload: ApplicationSaveData): Promise<boolean> => {
        try {
            const response = await fetch(`https://quantnow-sa1e.onrender.comions/${id}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json', ...getAuthHeaders() },
                body: JSON.stringify(payload)
            });
